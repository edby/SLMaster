...
<head>
	...
	<script language="javascript">
        ...
        function addTaskFun() {
            ...
            if (rows != "") {
                top.$.messager.confirm("确认对话框", "您是否要新增撤销机器人？", function (b) {
                    if (b) {
                        $.ajax({
                            type: "POST",
                            url: "${ctx}/robot/addRobotTask.do",
                            data: {
                                "id": rows[0].id
                            },
                            dataType: "json",
...
<div id="toolbar" style="display: none;">
	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="addFun()">新增机器人</a>
	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="addTaskFun()">新增机器人任务</a>

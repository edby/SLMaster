...
public class OrderSpotServiceImpl implements OrderSpotService {
    ...
    @Override
    public List<OrderSpot> selectAllCondition(Map<Object, Object> param) {
        return this.orderSpotMapper.selectAllCondition(param);
    }

    @Override
    public int updateConcurrencyOrder(OrderSpot record) {
        return this.orderSpotMapper.updateConcurrencyOrder(record);
    }
